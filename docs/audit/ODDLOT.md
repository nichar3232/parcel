...
The original dependency audit reported two moderate entries in an unused upstream streaming parser; no critical/high findings. No upstream dependency changes were required for Oddlot. This is builder verification, not an independent financial-security audit.
